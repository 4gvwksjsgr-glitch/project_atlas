-- =============================================================================
-- Project Atlas — Step 14C-2F-E: Paddle Simulator event_id support (sandbox)
-- Additive. Broadens external_event_id validation for paddle/test only:
--   evt_<26> | ntfsimevt_<26>
-- No signature/public wrapper/permission/checkout/entitlement changes.
-- =============================================================================
...
COMMENT ON FUNCTION private.ingest_paddle_sandbox_webhook_event(
  ...
  '14C-2F-E: paddle/test inbox. Accepts evt_/ntfsimevt_ event ids. No billing writes.';
...
-- Public wrapper signature and service_role EXECUTE grant unchanged; reconfirm.

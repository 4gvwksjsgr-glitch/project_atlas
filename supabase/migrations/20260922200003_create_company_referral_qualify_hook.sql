-- =============================================================================
-- Project Atlas — Working Step 17: create_company referral qualification hook
-- Qualifies a pending claimed referral when the referred user creates their
-- first company (owner). Does NOT mutate entitlement / Paddle state.
-- =============================================================================
...
BEGIN
  ...
  -- Referral qualification (ledger only; no Premium entitlement grant).
  PERFORM private.qualify_referral_on_company_create(v_company.id, v_user_id);
...
COMMENT ON FUNCTION public.create_company(TEXT, TEXT) IS
  'Crea company + owner + subscription Free + billing none/idle; qualifica referral pending (ledger only).';
